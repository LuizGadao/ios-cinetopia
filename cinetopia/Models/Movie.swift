...
let myListMovies: [Movie] = [
    ...
    Movie(id: "3", title: "Harry Potter e as Relíquias da Morte - Parte 1", image: "HP-2", synopsis: "A batalha entre as forças do bem e do mal da magia alcançam o mundo dos trouxas. O risco nunca foi tão grande, e ninguém está seguro. Harry Potter precisa fazer um sacrifício final conforme o confronto com Lord Voldemort se aproxima.", rate: 9.5, releaseDate: "15/07/2011"),
    Movie(id: "3", title: "Harry Potter e as Relíquias da Morte - Parte 3", image: "HP-2", synopsis: "A batalha entre as forças do bem e do mal da magia alcançam o mundo dos trouxas. O risco nunca foi tão grande, e ninguém está seguro. Harry Potter precisa fazer um sacrifício final conforme o confronto com Lord Voldemort se aproxima.", rate: 9.5, releaseDate: "15/07/2011"),
    Movie(id: "3", title: "Harry Potter e as Relíquias da Morte - Parte 4", image: "HP-2", synopsis: "A batalha entre as forças do bem e do mal da magia alcançam o mundo dos trouxas. O risco nunca foi tão grande, e ninguém está seguro. Harry Potter precisa fazer um sacrifício final conforme o confronto com Lord Voldemort se aproxima.", rate: 9.5, releaseDate: "15/07/2011"),
    Movie(id: "3", title: "Harry Potter e as Relíquias da Morte - Parte 5", image: "HP-2", synopsis: "A batalha entre as forças do bem e do mal da magia alcançam o mundo dos trouxas. O risco nunca foi tão grande, e ninguém está seguro. Harry Potter precisa fazer um sacrifício final conforme o confronto com Lord Voldemort se aproxima.", rate: 9.5, releaseDate: "15/07/2011"),
]
